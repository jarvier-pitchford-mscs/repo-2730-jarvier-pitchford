...
Public Class frmMain
    ...
    Private Sub btnCalc_Click(sender As Object, e As EventArgs) Handles btnCalc.Click
        ...
        Const strMSG As String = "You have exceeded the maximum guest per room."
        ...
        'caluculate toatal number of guests
        ...
        'adequate and then either display a amessage or
    ...
    Private Sub txtRooms_Enter(sender As Object, e As EventArgs) Handles txtRooms.Enter
        'select contents when text box recieves focus
