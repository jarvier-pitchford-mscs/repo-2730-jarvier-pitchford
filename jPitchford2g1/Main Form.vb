...
Public Class frmMain
    ...
    Private Sub ClearLabel(sender As Object, e As EventArgs) Handles txtQuantity.TextChanged, txtPrice.TextChanged
    ...
    Private Sub btnCalc_Click(sender As Object, e As EventArgs) Handles btnCalc.Click
        ...
        If intQuantity > 16 AndAlso intQuantity <= 20 Then
            dblRate = 0.025
        End If
